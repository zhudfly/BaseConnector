...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        netConnector.getBootPageAdvert(AppInfoUtil.getVersionName(), new BaseNetListener<BootAdvEntity>() {
            @Override
            public void onStart() {
                Logger.e("getBootPageAdvert onStart");
            }

            @Override
            public void onSuccess(String message, BootAdvEntity data) {
                Logger.e("getBootPageAdvert onSuccess");
            }

            @Override
            public void onError(BaseApiException apiException) {
                Logger.e("getBootPageAdvert onError");
            }

            @Override
            public void onFinish() {
                Logger.e("getBootPageAdvert onFinish");
            }
        });
    }
